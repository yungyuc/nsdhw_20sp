...
Duration: 13th April (Mon) -- 29th April (Wed).  Cut-off date is 6th May (Wed).
...
larger than or equal to ``1000x1000``.
...
working directory (``nsdhw_20sp/hw3/$username/``).  The hierarchy should be::
